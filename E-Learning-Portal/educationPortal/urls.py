...
urlpatterns = [
    ...
    path("ViewClassroom/<str:code>/assignments/viewAssignment/<int:assignmentId>/<int:id>/grade",
     ...
     # material stuff
    path("ViewClassroom/<str:code>/material",
          views.material, name = "materials"),
    path("ViewClassroom/<str:code>/material/createMaterial",
         views.createMaterial, name="createMaterial"),
    path("ViewClassroom/<str:code>/material/viewMaterial/<int:id>",
         views.viewMaterial, name="viewMaterial"),
